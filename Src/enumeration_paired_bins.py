...
"""
The restricted version considers multibins
"""
def enumeration_between_nodes_restr(graph,transkripts:list,node:str,path:list,endnode,act_bins,bins):
    ...
    if node == endnode:
        ...
        for n in succ:
            ...
            # Follow the path
            enumeration_between_nodes_restr(graph,transkripts,n,(path + [n]),endnode,new_bins,bins)          
