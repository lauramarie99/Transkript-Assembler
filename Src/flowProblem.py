...
def writeGStar (graph:dict, cost_index):
    ...
    for edgeKey, edgeValue in graph.edges.items():
        ...
        graphStar.add_edge(edgeKey[1], edgeKey[0], capacity = coverage, weight=100*(costFunction(coverage, cost_index, 0))) # Add backward edges with capacity (counts) of original forward edges and costFunction
